...
const command = {
	...
	language: {
		...
		run: {
			...
			unload_complete_succeed: `The language \`{{language}}\` has been unloaded successful.`,
			unload_complete_failed: `The language \`{{language}}\` could not be unloaded.`,
			unload_failed: `The language \`{{language}}\` could not be unloaded.\n\`{{error}}\``,
