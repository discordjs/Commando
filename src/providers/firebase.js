...
/**
 * Uses an Firebase database to store settings with guilds
 * @extends {SettingProvider}
 */
class FirebaseProvider extends SettingProvider {
	/**
	 * @external admin
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin}
	 */
	/**
	 * @external admin.app
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin.app}
	 */
	/**
	 * @external admin.database
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin.database}
	 */
	/**
	 * @external admin.app.App
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin.app.App}
	 */
	/**
	 * @external admin.database.Database
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin.database.Database}
	 */
	/**
	 * @external admin.database.Reference
	 * @see {@link https://firebase.google.com/docs/reference/admin/node/admin.database.Reference}
	 */
	...
	constructor(app) {
		...
		/**
		 * Database from your Firebase application
		...
		/**
		 * Database from your Firebase application
		 * @type {admin.database.Reference}
		 * @private
		 */
		this.ref = this.db.ref('settings');
	...
	async init(client) {
		...
		for(const guild in rows) {
			let settings = rows[guild];
	...
	destroy() {
		...
		// To stay complaint with the base method
	...
	async set(guild, key, val) {
		...
		settings[key] = val;
		await this.ref.child(guild).set(settings);
	...
	async clear(guild) {
		...
		await this.ref.child(guild).set(null);
	}
